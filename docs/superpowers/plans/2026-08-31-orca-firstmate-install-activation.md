...
ofm_wait_any_run() {  # <timeout_ms>
  ...
  (
    ...
    # ngược điều ta muốn. Trap dưới đây lo đường thoát êm; group lo đường bị cắt.
